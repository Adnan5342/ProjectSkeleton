...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblWelcome" runat="server" Font-Size="XX-Large" style="z-index: 1; left: 469px; top: 134px; position: absolute" Text="Welcome to the Admin System. "></asp:Label>
        ...
        <asp:LinkButton ID="lnkBtnSignOut" runat="server" OnClick="lnkBtnSignOut_Click" style="z-index: 1; left: 643px; top: 419px; position: absolute">Sign out</asp:LinkButton>
        <asp:Label ID="lblMovieCount" runat="server" style="z-index: 1; left: 425px; top: 236px; position: absolute" Text="Movie Count: "></asp:Label>
        <asp:Label ID="lblShowCount" runat="server" style="z-index: 1; left: 592px; top: 236px; position: absolute" Text="TV Show Count: "></asp:Label>
        <asp:Label ID="lblUserCount" runat="server" style="z-index: 1; left: 761px; top: 236px; position: absolute" Text="User Count: "></asp:Label>
        <asp:Label ID="lblMessageCount" runat="server" style="z-index: 1; left: 761px; top: 324px; position: absolute" Text="Message Count: "></asp:Label>
        <asp:Label ID="lblMReviewCount" runat="server" style="z-index: 1; left: 425px; top: 324px; position: absolute" Text="Review Count: "></asp:Label>
        <asp:Label ID="lblSReviewCount" runat="server" style="z-index: 1; left: 592px; top: 324px; position: absolute" Text="Review Count: "></asp:Label>
    </form>
</body>
</html>
