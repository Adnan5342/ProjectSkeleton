...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnDelete" runat="server" height="26px" OnClick="btnDelete_Click" style="z-index: 1; left: 16px; top: 594px; position: absolute" Text="Delete review" width="136px" />
            ...
            <asp:LinkButton ID="lnkBtnShowReviews" runat="server" OnClick="lnkBtnShowReviews_Click" style="z-index: 1; left: 234px; top: 141px; position: absolute">Reviews for shows</asp:LinkButton>
        </p>
