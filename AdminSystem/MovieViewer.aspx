...
<body>
    <form id="form1" runat="server">
        ...
        <p>
        <asp:Label ID="lblMovieDetails" runat="server" style="z-index: 1; left: 255px; top: 143px; position: absolute" Text="Movie Details" Font-Bold="True" Font-Overline="True" Font-Size="X-Large" Font-Underline="True"></asp:Label>
        </p>
        <p>
        ...
        <asp:Button ID="btnMovieList" runat="server" OnClick="btnMovieList_Click" style="z-index: 1; left: 255px; top: 563px; position: absolute" Text="Back to movie list" />
    </form>
</body>
</html>
