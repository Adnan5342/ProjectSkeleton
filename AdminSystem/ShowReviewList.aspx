...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <asp:LinkButton ID="lnkBtnMovieReviews" runat="server" OnClick="lnkBtnMovieReviews_Click" style="z-index: 1; left: 570px; top: 260px; width: 150px; position: absolute">Movie Review List</asp:LinkButton>
        </p>
        ...
        <asp:LinkButton ID="lnkBtnShows" runat="server" style="z-index: 1; left: 570px; top: 294px; width: 150px; position: absolute; bottom: 311px;" OnClick="lnkBtnShows_Click">TV Show List</asp:LinkButton>
        <asp:LinkButton ID="lnkBtnMovies" runat="server" style="z-index: 1; left: 570px; top: 327px; width: 150px; position: absolute" OnClick="lnkBtnMovies_Click">Movie List</asp:LinkButton>
