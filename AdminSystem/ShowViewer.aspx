...
<body>
    <form id="form1" runat="server">
        ...
        <p>
        <asp:Label ID="lblShowDetails" runat="server" style="z-index: 1; left: 20px; top: 152px; position: absolute" Text="TV Show Details" Font-Bold="True" Font-Overline="True" Font-Size="X-Large" Font-Underline="True"></asp:Label>
        </p>
        <p>
        ...
        <asp:Label ID="lblGenreText" runat="server" style="z-index: 1; left: 367px; top: 223px; width: 400px; position: absolute"></asp:Label>
        ...
        <asp:Label ID="lblCreatorsText" runat="server" style="z-index: 1; left: 367px; top: 283px; width: 400px; position: absolute"></asp:Label>
        ...
        <asp:Label ID="lblStarActorsText" runat="server" style="z-index: 1; left: 367px; top: 311px; width: 400px; position: absolute"></asp:Label>
        <asp:Label ID="lblSeasons" runat="server" style="z-index: 1; left: 266px; top: 336px; position: absolute" Text="Seasons: "></asp:Label>
        <asp:Label ID="lblSeasonsText" runat="server" style="z-index: 1; left: 367px; top: 338px; width: 400px; position: absolute"></asp:Label>
        ...
        <p>
        <asp:Button ID="btnShowList" runat="server" OnClick="btnShowList_Click" style="z-index: 1; left: 17px; top: 563px; position: absolute" Text="Back to TV show list" />
        </p>
    </form>
</body>
</html>
