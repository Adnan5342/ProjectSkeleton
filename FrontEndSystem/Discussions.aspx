...
<body>
    <div>
        <form id="form1" runat="server">
            ...
            <asp:Label ID="lblErrorEx" runat="server" style="z-index: 1; left: 421px; top: 760px; position: absolute"></asp:Label>
            ...
            <asp:TextBox ID="txtMessage" runat="server" style="z-index: 1; left: 36px; top: 667px; position: absolute; height: 72px; width: 342px" TextMode="MultiLine"></asp:TextBox>
            <asp:Button ID="btnSend" runat="server" OnClick="btnSend_Click" style="z-index: 1; left: 39px; top: 753px; position: absolute" Text="Send message" />
            <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 232px; top: 765px; position: absolute"></asp:Label>
        </form>
    </div>
</body>
</html>
