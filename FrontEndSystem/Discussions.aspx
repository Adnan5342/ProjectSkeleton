...
<body>
    <div>
        <form id="form1" runat="server">
            ...
            <asp:Label ID="lblTitle" runat="server" SelectionMode="Single" Font-Bold="True" Font-Italic="False" Font-Size="XX-Large" Font-Underline="True" style="z-index: 1; left: 625px; top: 98px; position: absolute" Text="Discussion Board"></asp:Label>       
