...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ListBox ID="lstMovieList" runat="server" style="z-index: 1; left: 17px; top: 186px; position: absolute; height: 134px; width: 221px"></asp:ListBox>
        ...
        <asp:Button ID="btnViewMovie" runat="server" style="z-index: 1; left: 17px; top: 331px; position: absolute" Text="View movie" OnClick="btnViewMovie_Click" />
        <asp:Button ID="btnViewShow" runat="server" height="26px" style="z-index: 1; left: 277px; top: 331px; position: absolute" Text="View show" width="99px" OnClick="btnViewShow_Click" />
        <asp:Label ID="lblMovieError" runat="server" style="z-index: 1; left: 21px; top: 370px; position: absolute"></asp:Label>
        <asp:Label ID="lblShowError" runat="server" style="z-index: 1; left: 282px; top: 369px; position: absolute"></asp:Label>
    </form>
</body>
</html>
