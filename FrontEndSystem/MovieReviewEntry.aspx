...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblMovieId" runat="server" style="z-index: 1; left: 230px; top: 146px; position: absolute" Text="Movie ID: "></asp:Label>
        <asp:Label ID="lblRating" runat="server" style="z-index: 1; left: 231px; top: 174px; position: absolute" Text="Rating"></asp:Label>
        <asp:Label ID="lblComment" runat="server" style="z-index: 1; left: 228px; top: 206px; position: absolute" Text="Comment"></asp:Label>
        <asp:TextBox ID="txtMovieId" runat="server" style="z-index: 1; left: 311px; top: 144px; position: absolute"></asp:TextBox>
        <asp:TextBox ID="txtRating" runat="server" style="z-index: 1; left: 311px; top: 174px; position: absolute"></asp:TextBox>
        <asp:TextBox ID="txtComment" runat="server" style="z-index: 1; left: 314px; top: 209px; position: absolute; height: 92px; width: 252px; bottom: 369px" TextMode="MultiLine"></asp:TextBox>
